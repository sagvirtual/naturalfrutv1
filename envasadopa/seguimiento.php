...
if($preparado=='9'){
        ...
        $sqlordenx=mysqli_query($rjdhfbpqj,"SELECT * FROM itemenvasa Where id_orden = '$iditemdfd' and listo='0'");
...
if($nosegui!="1"){
 $sqlordend = "Update ordenevaa Set preparado='$preparado', usuario='$nombrenegocio', horaentrega='$horaentrega', fechaentreg='$fechahoy', id_usuarioclav='$id_usuarioclav' Where id = '$iditemdfd'";
mysqli_query($rjdhfbpqj, $sqlordend) or die(mysqli_error($rjdhfbpqj));

//paso seguimiento
$sqlnum=mysqli_query($rjdhfbpqj,"SELECT * FROM ordenevaa Where id='$iditemdfd' and fin = '1'");
