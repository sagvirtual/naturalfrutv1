...
<?  if($tipo_usuario=="22"){$tit="10000000000000000";
    
    $sqlordenxgvr = mysqli_query($rjdhfbpqj, "SELECT * FROM ordenevaa  Where preparado= '1' and id_usuarioclav='$id_usuarioclav'");
...
<div id="accordion">
  ...
  $comilla="'";
    ...
    $sqlordenxgv = mysqli_query($rjdhfbpqj, "SELECT * FROM ordenevaa  Where preparado= '1'  ORDER BY `id` DESC");
    ...
    ?>
            ...
            <tbody>
                ...
                <?php
                $comillas="'";
                $sqlordenr = mysqli_query($rjdhfbpqj, "SELECT * FROM itemenvasa Where id_orden = '$idorhisc'");
                ...
                <td class="text-center" style="vertical-align: middle;place-items: center; width: 20mm;"><strong>' . $rowordentc['cantidad'] . ' ' . $rowordentc['unidad'] . '</strong></td>
