...
<div class="breadcrumbbar">
    ...
    <div class="col-md-12 col-lg-12">
        ...
        <h4 class="page-title" style="padding-right: 70px;"><i class="sl-icon-people"></i> Ventas Productos</h4>
    </div><br>
    <div class="col-md-12 col-lg-12">
        <f class="form-inline">
    ...
    <div class="col-md-12 col-lg-12">
        <f class="form-inline">
            ...
            <div class="form-group mx-sm-3 mb-2">
                <a onclick="ajax_buscar($('#desde_date').val(),$('#hasta_date').val(),$('#buscar').val(),$('#busproveedor').val(),'1')"
                    style="cursor: pointer;">
                    <button type="button" class="btn btn-dark"> Cliente/Factura</button>
                </a>
...
<script>
    function ajax_buscar(desde_date, hasta_date, buscar, busproveedor, factura) {
        var parametros = {
        ...
        $.ajax({
            data: parametros,
            url: 'buscar_ventas_productos.php',
            type: 'POST',
            beforeSend: function() {
