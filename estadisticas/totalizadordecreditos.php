...
<div class="contentbar">
                        ...
                        <table id="default-datatable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($palabras as $palabra) {
                                    $condiciones_busqueda .= "(clientes.nom_contac LIKE '%$palabra%' OR nota_credito.id LIKE '%$palabra%' OR clientes.nom_empr LIKE '%$palabra%' ) AND ";
                                }
    ...
    nota_credito.id, nota_credito.total, nota_credito.fecha, nota_credito.col,nota_credito.id_cliente
    FROM clientes
    INNER JOIN nota_credito ON nota_credito.id_cliente = clientes.id 
    WHERE ($condiciones_busqueda) AND nota_credito.fecha BETWEEN '$desde_date' AND '$hasta_date'  
    ORDER BY `nota_credito`.`fecha` ASC");

                                /* 
    WHERE ($condiciones_busqueda) AND nota_credito.fecha BETWEEN '$desde_date' AND '$hasta_date'  AND nota_credito.col>='2' 
    ORDER BY `nota_credito`.`fecha` ASC");
    */
