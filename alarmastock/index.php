...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title"> Productos sin o poco Stock</h4>
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <td style="text-align:left;">
                        ...
                        <td style="width: 29mm;text-align:center;color:red;">' . $CantStocks . ' ' . $unidadnom . '</td>
                       ...
                       ' . $comilla . '' . $rowproductosrg["id"] . '' . $comilla . ')" value="' . $alarmastock . '"
...
<script>
    function ajax_alarma(alarma, id_producto) {
        var parametros = {
            'alarma': alarma,
