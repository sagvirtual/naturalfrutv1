...
$sqlordenx = mysqli_query($rjdhfbpqj, "SELECT * FROM ordeneva Where fin='0' and manu='0'");
...
$sqlordent = mysqli_query($rjdhfbpqj, "SELECT * FROM itemenvas Where id_orden = '$id_orden'");
...
<body onclick="ajax_buscar('dsdssddds');">
    ...
    <div class="bg-success text-white text-center" style="padding-left: 10px; padding-right: 10px; flex-shrink: 0;" style="background-color: #0B6CF7; ">
        <p style=" font-size: 10pt; color: white;">Sistema de Pedidos internos Versión 1.0.1 </p>
    </div>
    <?php
    if ($_SESSION['tipo'] == "21") {
        $sectors = "21";
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-6">
                    <h2> <input type="number" name="numero" id="numero" value="<?= $numero ?>" class="form-control" placeholder="Número Pedido para ENVASADO" onkeyup="detectarEnterb(event)"></h2>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1" style="padding-top: 10px;">
                <button type="button" id="suminstr" class="btn btn-success" onclick="ajax_ordeneva($('#producto').val(), $('#unidad').val(), $('#cantidad').val(),$('#numero').val());" style="width: 100%; <?= $verinpur ?>">Agregar</button>
            </div>
        </div>
        <!-- </form> -->
    ...
    <? if ($id_orden != "dsds" && $veritem == "1") { ?>
        ...
        <div class="container mt-3 text-center">
            <!-- <a href="printorden.php"> <button type="button" class="btn btn-dark">Imprimir  Orden</button></a> <br><br>   --><a href="guardarorden.php"><button type="button" class="btn btn-dark">Enviar a Envasado</button></a>
        </div>
        <br><?php
...
<?php } else { ?>
    <div class="col-7">
        ...
        <ul class="list-group" style="width: 100%;">
            ...
            <li class="list-group-item">Pedir Producto:<strong> <a href="/depositoplantaalta/">Deposito Planta Alta</a></strong></li>
            ...
            <li class="list-group-item">
                <a href="../stockeo/index.php?ubicacion=2" target="_blank" style="float:left;">Stockear</a></strong>

                <a href="../produccionenva/historialenvasado" target="_blank" style="float:right;">Historial</a></strong>
            </li>
        </ul>
