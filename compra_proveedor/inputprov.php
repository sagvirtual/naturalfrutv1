...
<form id="formBusqucl" class="input-group mb-1">
 <input type="text" class="form-control"  id="id_cliente" name="id_cliente" style="height: 50px;" placeholder="Buscar Proveedor..." value="<?= $nombreproved ?>" autocomplete="off" onclick="select()" onkeypress="return event.keyCode != 13;" <?=$notab?>>
</form>
    ...
    $('#id_cliente').on('keyup', function(e) {
        ...
        if (e.keyCode === 38) { // Flecha arriba
            ...
            if (indiceseleccionacld !== -1) {
                ...
                var url = "?ookdfv=" + encodeURIComponent(seleccionacld) ;
