...
if (!empty($file)) {
    ...
    $sqlbanneri = "INSERT INTO `cartelitos` (position, anclaje) VALUES ('$position', '$anclaje');";
    mysqli_query($rjdhfbpqj, $sqlbanneri) or die(mysqli_error($rjdhfbpqj));


    $sqlbanner = mysqli_query($rjdhfbpqj, "SELECT * FROM cartelitos Where anclaje = '$anclaje'");
