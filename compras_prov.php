...
<div class="breadcrumbbar">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <h4 class="page-title" style="padding-right: 70px;"><i class="sl-icon-people"></i> Compras Proveedores</h4>
                </div>
                <div class="form-group mb-2">
           ...
           <div class="form-group mx-sm-3 mb-2">
                <div class="widgetbar">
                <a href="../compra_proveedor" target="_blank"><button class="btn btn-primary"><i class="feather icon-user-plus mr-2"></i>Agregar Compras</button></a>
            </div>
...
<script>
    function ajax_buscar(desde_date,hasta_date,buscar) {
        ...
        $.ajax({
            data: parametros,
            url: '/lcompras/buscarcomprasprov.php',
            type: 'POST',
            beforeSend: function() {
