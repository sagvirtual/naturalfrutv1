...
<div id="cudrobus" class="fonbus">
    ...
    if (!empty($_POST['id_cliente']) && $_POST['id_cliente'] != ' ' && $_POST['id_cliente'] != null)
        ...
        $sqlordenc = mysqli_query($rjdhfbpqj, "SELECT nom_empr,address,localidad,id,nom_contac FROM clientes Where  $condicion_fincl  and estado='0' ORDER BY `clientes`.`nom_empr` ASC Limit 20");
