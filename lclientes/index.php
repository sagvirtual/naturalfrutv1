...
$sqlorden = mysqli_query($rjdhfbpqj, "SELECT * FROM orden Where id_cliente = '$id' and col='8'");
...
if ($rowclientes = mysqli_fetch_array($sqlclientes)) {
    ...
    $razonsocial = $rowclientes["razonsocial"];
    ...
    if ($error == "1") {
        ...
        $cod_fac = $_SESSION["cod_fac"];
        $iva_por = $_SESSION["iva_por"];
        $persep_por = $_SESSION["persep_por"];
        $facturado = $_SESSION["facturado"];
...
<div class="breadcrumbbar">
    ...
    <a href="../nota_de_pedido/index.php?jhduskdsa=' . $idcod . '&jufqwes=' . $_GET['jufqwes'] . '"> <button class="btn btn-primary"><i class="sl-icon-people"></i> Volver</button></a>
...
<!-- End Breadcrumbbar -->
<!-- Start Contentbar -->
<form action="insert_cliente.php" id="formda" name="formda" method="post" target="_parent">
    <div class="contentbar">

        <? if ($modocl == '1') {
            echo '
    
    <input type="hidden" id="modocl" name="modocl" value="1">
            ...
            <div class="col-lg-6">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">Datos idCli. <?= $id ?></h5>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre NEGOCIO:</label><?= $_SESSION["nom_empr"] ?>
                                <input type="text" class="form-control" id="nom_contac" name="nom_contac" value="<?= $nom_contac ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre Contacto</label>
                                <input type="text" class="form-control" id="nom_empr" name="nom_empr" value="<?= $nom_empr ?>" required>
                                <input type="hidden" id="jufqwes" name="jufqwes" value="<?= $_GET['jufqwes'] ?>">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="direccion" name="direccion" class="form-control" value="<?= $address ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Localidad</label>
                                <input type="text" id="localidad" name="localidad" class="form-control" value="<?= $localidad ?>" required>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4"> Horarios</label>
                                <input type="text" class="form-control" id="horarios" name="horarios" value="<?= $horarios ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4"> WhatsApp</label>
                                <input type="number" class="form-control" id="wsp" name="wsp" value="<?= $wsp ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-4" style="display:none;"> <br><br>
                                <img src="<?= $foto ?>" alt="" style="width: 200px; height:200px; text-align:left;">
                            </div>
                            <div class="form-group col-md-8" style="display:none;"> <br><br>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="custom-select" name="tipo_cliente" id="tipo_cliente">
                                    <!--  <option value="0" <? //= $tipo_clientesel0 
                                                            ?>>Minorista</option> -->
                            ...
                            <div class="form-group col-md-4" style="display:none;">
                                <label for="inputEmail4">Lista</label><br>
 ...
 -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label for="inputEmail4">Razón Social</label><br>

                                <input type="text" class="form-control" name="razonsocial" id="razonsocial" value="<?= $razonsocial ?>">
                            </div>
                            <div class="form-group col-md-4">

                                <label for="cod_fac"> Codigo Facturación</label>
                                <input type="text" class="form-control" id="cod_fac" name="cod_fac" value="<?= $cod_fac ?>">

                            </div>
                            <div class="form-group col-md-4">
                                <label for="iva_por"> IVA %</label>
                                <input type="text" class="form-control" id="iva_por" name="iva_por" value="<?= $iva_por ?>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="persep_por"> Percep. %</label>
                                <input type="text" class="form-control" id="persep_por" name="persep_por" value="<?= $persep_por ?>">
                            </div>
                            <div class="custom-control custom-switch form-group col-md-4">
                                <label for="inputEmail4">Aplicar Impuestos</label><br>&nbsp;&nbsp;
                                <input type="checkbox" class="custom-control-input" id="facturado" name="facturado" value="1" style="text-align: right; position:relative; left:80px;" onclick="ajax_facturado($('#id_cliente').val(), $('input:checkbox[name=facturado]:checked').val());" <?= $checkedf ?>>
                                <label class="custom-control-label" for="facturado"></label>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <div class="alert alert-primary" role="alert">
                                    ...
                                    <input type="hidden" id="jjdnhsa" name="jjdnhsa" value="<?= $idcod ?>" style="display:none;">
                            ...
                            <div class="form-group col-md-4">
                                <div class="alert alert-primary" role="alert">
                                    ...
                                    <select id="zona" name="zona" class="custom-select ">
                                        <?php
                                        $sqlzona = mysqli_query($rjdhfbpqj, "SELECT * FROM zona ORDER BY `zona`.`position` ASC");
                                        while ($rowzona = mysqli_fetch_array($sqlzona)) {

                                            echo '<option value="' . $rowzona["id"] . '"';

                                            if ($zonaid == $rowzona["id"]) {
                                                echo 'selected';
                                            }
                                            echo '>' . $rowzona["nombre"] . ' (' . $rowzona["estado"] . ')</option>';
                                        }
                                ...
                                <div class="alert alert-primary" role="alert">
                                    ...
                                    <select id="picking" name="picking" class="custom-select ">
                                        <option value="0">--Libre--</option>
                                        <?php
                                        $sqlpick = mysqli_query($rjdhfbpqj, "SELECT * FROM usuarios Where tipo_cliente='34' ORDER BY nom_contac ASC");
                                        while ($rowzpci = mysqli_fetch_array($sqlpick)) {

                                            echo '<option value="' . $rowzpci["id"] . '"';

                                            if ($idpick == $rowzpci["id"]) {
                                                echo 'selected';
                                            }
                                            echo '>' . $rowzpci["nom_contac"] . ' </option>';
                                        }
                        ...
                        <? if (!empty($idcod)) { ?>
                            <div class="accordion accordion-outline" id="accordionoutline" style="display:none">
                                <div class="card">
...
<script>
    ...
    function ajax_facturado(id_cliente, facturado) {
        var parametros = {
            "id_cliente": id_cliente,
            "facturado": facturado
        };
