    ...
    <table class="tabla_sin" style="width: 100%;">
        <tr class="tr_linea">
            <td class="celda_sin" style="text-align: center; ">
                <p style="text-align:center;font-size:12pt; font-weight: bold;"> ORDEN DE CARGA <br>CAMIONETA</p>
                        ...
                        <td>
                            ...
                            while ($rowcategorias = mysqli_fetch_array($sqlcategorias)) {
                                ...
                                if ($rowproductos = mysqli_fetch_array($sqlproductosr)) {
                                    ...
                                    $sqlproductosv = mysqli_query($rjdhfbpqj, "SELECT e.id, e.categoria, e.position, u.id_producto, u.confirmado, u.fecha, u.id_proveedor
                                                        FROM productos e INNER JOIN carga u ON e.id = u.id_producto  Where e.categoria='$id_categoria' and u.fecha = '$desde_date' and u.id_proveedor='$id_clientedec' and u.confirmado='1'");

                                    if ($rowproductosre = mysqli_fetch_array($sqlproductosv)) {


                                        echo '<br><table  class="tabla_sin" style="width: 50mm;">
                                    ...
                                    while ($rowproductosr = mysqli_fetch_array($sqlproductosr)) {
                                        ...
                                        $sqlitem_orden = mysqli_query($rjdhfbpqj, "SELECT * FROM carga Where fecha = '$desde_date' and id_proveedor='$id_clientedec' and id_producto='$idproduff'");
                                        ...
                                        if ($rowitem_ordendis = mysqli_fetch_array($sqlitem_orden)) {
                                            ...
                                            $distin = ${"distin" . $id_producto};
                                            $sqlcargavo = ${"sqlcargavo" . $id_producto};
                                            $rowcargao = ${"rowcargao" . $id_producto};
                                            $kilosto = ${"kilosto" . $id_producto};
                                            ...
                                            //aca compraro si vario con el pedido original

                                            $sqlcargavo = mysqli_query($rjdhfbpqj, "SELECT * FROM item_orden Where fecha = '$desde_date' and id_proveedor='$id_clientedec' and id_producto='$id_producto' and modo='0'");
                                            while ($rowcargao = mysqli_fetch_array($sqlcargavo)) {
                                                $kilosto += $rowcargao["kilos"];
                                            }

                                            if($kilost !=$kilosto){$distin="*";}
                                            ...
                                            echo '<tr class="tr_linea">
                                                            ...
                                                            <td  class="celda_sin">'.$distin.'' . $nombreprod . '<br>' . $kilosver . '</td>
...
*******************************************
    ...
    *******************************************
    <table class="tabla_sin" style="width: 100%;">
        <tr class="tr_linea">
            <td class="celda_sin">
                <p style="text-align:center;font-size:12pt; font-weight: bold;"> CONTROL DE CARGA <br>CAMIONETA</p>
    ...
    <div class="card-body" style="border: 0px solid black; ">
        ...
        <div class="table-responsive m-b-30" style="border: 0px solid black; width: 100%;">
            ...
            <div class="table-responsive m-b-30" style="width: 100%;">
                <table class="table table-bordered" style="background-color: #fff; ">
                    <tr>
                        <td>
                                ...
                                if ($rowproductos = mysqli_fetch_array($sqlproductosr)) {
                                    ...
                                    while ($rowproductosr = mysqli_fetch_array($sqlproductosr)) {
                                        ...
                                        if ($rowitem_ordendis = mysqli_fetch_array($sqlitem_orden)) {
                                            ...
                                            $bultosb += $cajonenterow;
                                            $bultoskilb += $pediporkilovw;
                    ...
                    <tr class="tr_linea">
                        <td class="celda_sin">
                            <p style="text-align:left;font-size:12pt; font-weight: bold;">Bultos&nbsp;<?= $bultosb ?> y <?= $bultoskilb ?> Kilos</p>
                        </td>
    ...
    <script>
        ...
        setTimeout(function() {
            location.href = 'orden_carga?hfbbd=<?= $id_clientecod ?>&podjfuu=<?= $desde_datee ?>';
        }, 20000);
    </script>
