            ...
            <form class="form-inline">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    ...
                    <input type="search" id="buscar" name="buscar" style="width: 500px;" class="form-control"
                        placeholder="Buscar por: Nº Presupuesto / Cliente / Localidad / Direccíon" aria-label="Search" aria-describedby="button-addon2"
            ...
            <div class="widgetbar">
                ...
                <a href="../presupuesto/">
                    <button class="btn btn-primary"><i
                            class="feather icon-user-plus mr-2"></i>Nuevo Presupuesto</button></a>
...
<script>
    function ajax_buscartodo(buscar, desde_date, hasta_date, col) {
        ...
        $.ajax({
            data: parametros,
            url: '../presupuesto/buscarpresupuesto.php',
            type: 'POST',
            beforeSend: function() {
