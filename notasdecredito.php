    ...
    <div class="row align-items-center">
            ...
            <form class="form-inline">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    ...
                    <input type="search" id="buscar" name="buscar" style="width: 500px;" class="form-control"
                        placeholder="Buscar por: Nº Nota de Credito / Cliente / Localidad / Direccíon" aria-label="Search" aria-describedby="button-addon2"
                        onkeyup="ajax_buscar($('#buscar').val(),$('#desde_date').val(),$('#hasta_date').val(),'');" autocomplete="off">


                    &nbsp;&nbsp;&nbsp;
                    <a onclick="ajax_buscartodo('',$('#desde_date').val(),$('#hasta_date').val(),'');" style="cursor: pointer;">
        ...
        <div class="col-md-2 col-lg-2">
            <div class="widgetbar">
                ...
                <a href="../nota_de_credito/">
                    <button class="btn btn-primary"><i
                            class="feather icon-user-plus mr-2"></i>Nueva Nota de Crédito</button></a>
...
<script>
    function ajax_buscartodo(buscar, desde_date, hasta_date, col) {
        ...
        $.ajax({
            data: parametros,
            url: '../nota_de_credito/buscarcnotascredito.php',
            type: 'POST',
            beforeSend: function() {
