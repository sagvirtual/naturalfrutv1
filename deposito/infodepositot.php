...
<head>
    <title>Sistema de Informacíon de Deposito </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="bg-success text-white text-center" style="padding-left: 10px; padding-right: 10px; flex-shrink: 0;" style="background-color: #0B6CF7; ">
        <p style=" font-size: 10pt; color: white;">Sistema de Informacíon Deposito&nbsp;&nbsp; Usuario:&nbsp;<strong> <?=$nombrenegocio?></p>
    </div>
...
<div class="col-4">
  <? 
  if ($tipo_usuario=='29'){echo '<a href="../depositoplantaalta/index.php">';}
  elseif ($tipo_usuario=='22'){echo '<a href="../envasadopa/index.php">';}
  
  
  ?>
                    <button type="button" id="suminstr2" class="btn btn-danger" style="width: 100%;">Ir a los Pedidos</button>
                </a>
