<?php
 function Vencimiento($rjdhfbpqj,$id_clienteint){
    ...
    $sqlpagdeufp = mysqli_query($rjdhfbpqj, "SELECT * FROM ordenprovee Where id_proveedor = '$id_clienteint' and cerrado='1' ORDER BY `ordenprovee`.`fecha` DESC");
...
$diasvedver=$totalven.' días';

}else{$diasvedver='<i style="color:#ccc;">Sin Deuda</i>';}
