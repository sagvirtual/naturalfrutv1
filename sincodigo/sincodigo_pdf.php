...
<table style="width: 100%;">
    ...
    <tbody>
        ...
        while ($rowcategoriasb = mysqli_fetch_array($sqlcategoriasb)) {
            ...
            $sqlproductosv = mysqli_query($rjdhfbpqj, "SELECT * FROM productos Where categoria='$id_categoria' and  codigo='0' and estado='0' ");
            ...
            $sqlordenr = mysqli_query($rjdhfbpqj, "SELECT  id,nombre,estado,codigo,pascol,id_rubro9 FROM productos WHERE id_rubro9='0' and 
             categoria='$id_categoria' and codigo='0' and estado='0' ORDER BY nombre ASC");
