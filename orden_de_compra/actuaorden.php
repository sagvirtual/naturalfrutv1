...
include('../lusuarios/login.php');
 ...
 if(!empty($idorden)){
 $sqlclientes = "Update ordencompra Set  subtotal='$subtotal', uniddesc='$uniddesc', desporsen='$desporsen', descuento='$descuento', perporsen='$perporsen', totalper='$totalper', ivaporsen='$ivaporsen', totalivas='$totalivas', total='$total', anterior='$anterior', pago='$pago', saldo='$saldo' Where id = '$idorden'";
