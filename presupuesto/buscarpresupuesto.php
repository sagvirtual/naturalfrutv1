                        ...
                        <table id="default-datatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 80px;" class="text-center">Nº&nbsp;Presupuesto
                                    </th>
                                    <th>Cliente</th>
                            ...
                            Where $qlovus e.col >= '0'");
                                ...
                                $sqluorden = mysqli_query($rjdhfbpqj, "SELECT e.id, e.fecha,e.ordedecompra,e.id_usuarioclav, e.col, e.saldo, e.id_cliente, u.nom_empr, u.nom_contac, u.retira, u.zona, u.address, u.localidad, u.id as nuncliente
                                FROM presupuesto e 
                                INNER JOIN clientes u 
                                ON e.id_cliente = u.id
                                ...
                                while ($rowuorden = mysqli_fetch_array($sqluorden)) {
                                    ...
                                    $sqlpagdeufp = mysqli_query($rjdhfbpqj, "SELECT * FROM presupuesto Where id_cliente = '$id_cliente'and col>='0' ORDER BY `presupuesto`.`id` DESC");
                                    ...
                                    echo '
                                          ...
                                          <td style="color: black;" class="text-center">' . NomPickin($rjdhfbpqj, $id_usuarioclav) . '</td>
                                    ...
                                    if ($Idordenultima == $Idordenultima) {
                                        echo '<a href="../presupuesto/?jhduskdsa=' . $id_clientecod . '&orjndty=' . $id_ordencod . '&ref=1">';
                                    } else {
                                        echo '<a href="../presupuesto/presupuesto_pdf?jdhsknc=' . $id_ordencod . '"  target="_blank" tabindex="-1" title="PDF Presupuesto">';
                                    }
                                    ...
                                    echo ' <button type="button" class="btn btn-secondary" style="background-color: #EAE9E9;color: black; font-weight: bold;">Nº&nbsp;' . str_pad($id_orden, 8, '0', STR_PAD_LEFT) . '</button></td>   
                                             ...
                                             <td style="text-align: right;" class="text-center">$' . number_format($saldo, 0, ',', '.') . '</td>
                                              ...
                                              <td class="text-center"><a href="../presupuesto/presupuesto_pdf?jdhsknc=' . $id_ordencod . '" class="btn btn-dark-rgba" target="_blank" tabindex="-1" title="PDF Presupuesto"><i class="dripicons-print"></i></a></td>
                                    ...
                                    if ($Idordenultima == $Idordenultima) {
                                        echo '
                                                    ...
                                                    <a href="../presupuesto/?jhduskdsa=' . $id_clientecod . '&orjndty=' . $id_ordencod . '&ref=1" class="btn btn-success-rgba" title="Editar"><i class="ri-pencil-line"></i></a>';
                                    }
                                    if ($colestado != '8') {
                                        echo ' 
                                                        <a href="javascript:void(0);" ondblclick="eliminar(' . "'/presupuesto/mlkdths?" . 'jnnfsc=' . $id_ordencod . '' . "'" . ')" class="btn btn-danger-rgba">
