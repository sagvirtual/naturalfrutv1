 ...
 */
    ...
    if ($id_orden == '' || $id_orden == 'dsds') {
        ...
        $sqlordenx = mysqli_query($rjdhfbpqj, "SELECT * FROM presupuesto Where finalizada='0' and id_cliente='$id_clienteint'");
    } else {
        $sqlordenx = mysqli_query($rjdhfbpqj, "SELECT * FROM presupuesto Where id='$id_orden'");
    }
    ...
    $sqlordent = mysqli_query($rjdhfbpqj, "SELECT * FROM item_presupues Where id_orden = '$id_orden' and id_orden != ''");
...
';
    ...
    $sqldord = mysqli_query($rjdhfbpqj, "SELECT * FROM item_presupues Where id_orden='$ordedecompra' and id_producto='$idproduc'");
...
?>
    ...
    <head>
        <title>Presupuesto - Natural Frut</title>
        <meta charset="utf-8">
    ...
    <body onload="caltotalven($('#valoiva').val(),$('#desuniva').val(),$('#desuni').val(),$('#valdvp').val())">
        <?php
        $sqlore = mysqli_query($rjdhfbpqj, "SELECT * FROM item_presupues Where id_orden = '$id_orden' and modo='0'");
        ...
        <div class="scrdesa">
            ...
            <div class="bg-primary text-white text-center" style="padding-left: 10px; padding-right: 10px; flex-shrink: 0;" style="background-color: blue; ">
                <p style=" font-size: 10pt; color: white;">Sistema de Nota de Presupuestos Versión 1.0.1</p>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-2" style="width: auto;  position: relative; float: left;">
                        ...
                        <a href="../listado_presupuesto" tabindex="-1">
                            ...
                            <table class="table table-bordered table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 150px;text-align:center;">Costo&nbsp;Unitario</th>
                                        <th style="width: 90px;text-align:center;">Ganancia&nbsp;(%)</th>
                                ...
                                <tbody>
                                    ...
                                    $sqlorden = mysqli_query($rjdhfbpqj, "SELECT * FROM item_presupues Where id_orden = '$id_orden'  and modo='0' ORDER BY `id` ASC");
...
<div id="muestroordenr' . $roworden['id'] . '"></div>
                            ...
                            <table class="table table-bordered table-sm" style="bottom: 300px; <?= $noverpro ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 150px;padding-left: 10px;">Costo Unitario</th>
                                        <th style="width: 90px;padding-left: 10px;">Ganancia&nbsp;(%)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center; ">
                                            <input type="text" name="totalimpor" id="totalimpor" value="" class="form-control" style="text-align:right; <?= $verinpur ?>" onclick="select()">

                                            <input type="hidden" name="importtot" id="importtot" value="0" class="form-control" style="text-align:right; <?= $verinpur ?>">
                                        </td>
                    ...
                    <div class="container mt-3 text-center"> <? if ($veritem == "1") { ?>
                            ...
                            <? if ($nombrvot == '2') { ?>
                                ...
                                <a href="presupuesto_pdf.php?jdhsknc=<?= base64_encode($id_orden) ?>" target="_blank" tabindex="-1"> <button type="button" class="btn btn-dark" tabindex="-1">Descargar PDF</button></a>

                            <? }
                                                                    if ($nombrvot == '1') { ?>
                                <button onclick="ajax_guardarorden($('#col').val());" type="button" class="btn btn-dark" tabindex="-1">Finalizar Presupuesto</button>
                            <? } ?>
                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <? } ?>
                        <a href="../listado_presupuesto" tabindex="-1"><button type="button" class="btn btn-danger" tabindex="-1">Salir</button></a>
            ...
            <script>
                function costoganncia(cantidad, descuenun, improteun) {
                    //valores 
                    var cantidad = cantidad;
                    var descuenun = descuenun;
                    var improteun = improteun;
                    ...
                    if (descuenun === undefined || descuenun === null || descuenun === '' || descuenun === '0') {
                        ...
                        /* descuento al totalfinal */
                        costoxbuldd = costoxbuldr + (improteun * (descuenun / 100));
                        document.getElementById('importtot').value = Math.round(costoxbuldd);
            ...
            <script>
                /* <input type="text" name="totalimpor" id="totalimpor" value="" class="form-control" style="text-align:right; <?= $verinpur ?>">

                                            <input type="text" name="importtot" id="importtot" value="0" class="form-control" style="text-align:right; <?= $verinpur ?>"> */
                document.getElementById('totalimpor').addEventListener('input', function(e) {


                    // Obtiene el valor actual, eliminando todo lo que no sean números
                    let valor = e.target.value.replace(/\D/g, '');

                    // Si no hay nada, deja vacío
                    if (valor === '') {
                        e.target.value = '';
                        return;
                    }

                    // Convierte a número y formatea con separadores de miles usando puntos
                    valor = parseFloat(valor).toLocaleString('es-AR');

                    // Asigna el valor formateado al input
                    e.target.value = valor;
                    let sinPuntos = valor.replace(/\./g, '');
                    document.getElementById('importtot').value = sinPuntos;

                    var cantidad = document.getElementById('cantidad').value;
                    var costo = document.getElementById('improteun').value;

                    let totalcosto = sinPuntos / cantidad;
                    let ganancia = ((totalcosto - costo) / costo) * 100;

                    document.getElementById('descuenun').value = ganancia.toFixed(4);
                });
            </script>
