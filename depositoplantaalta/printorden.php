...
<body>
    <?php
if($_GET['hist']=='1'){$id_orden = $_GET['id_orden'];}else{

    $id_orden = $_SESSION['id_orden'];
}
    $sqlordenx=mysqli_query($rjdhfbpqj,"SELECT * FROM ordenbajar Where id = '$id_orden'");
...
?>
    ...
    <table class="tabla_sin" style="width:100%">
       ...
       $sqlordend = "Update ordenbajar Set fin='1' Where id = '$id_orden'";
