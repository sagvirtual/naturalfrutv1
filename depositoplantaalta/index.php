...
$sinstok =  trim($productod[3]);
if ($sinstok == 'Sin Stock') {
    $sinno = '1';
} else {
    $sinno = '0';
}
...
/* fin */
if ($tipo_usuario == "0" || $_SESSION['tipo'] == "30") {
    if ($unidsx == "Kg.") {
        $seleuna = "selected";
    }
    if ($unidsx == "Uni.") {
...
$sqlordenx = mysqli_query($rjdhfbpqj, "SELECT * FROM ordenbajar Where fin='0' and sector='$tipo_usuario' and manu='0'");
...
$sqlordent = mysqli_query($rjdhfbpqj, "SELECT * FROM itembajar Where id_orden = '$id_orden'");
...
<head>
    <title>Orden Para Deposito Planta Alta</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="bg-success text-white text-center" style="padding-left: 10px; padding-right: 10px; flex-shrink: 0;" style="background-color: #0B6CF7; ">
        <p style=" font-size: 10pt; color: white;">Sistema de Pedidos internos Versión 1.0.2</p>
    </div>
    <?php
    if ($_SESSION['tipo'] == "29") {
        $sectors = "29";
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            <div class="col-5">
                <? if ($_SESSION['tipo'] == "30" || $_SESSION['tipo'] == "21") { ?> <a href="index.php<?= $editd ?>"> <? } ?><img src="/assets/images/logopc.png" style="width:38mm;"><? if ($_SESSION['tipo'] == "30" || $_SESSION['tipo'] == "21") { ?> </a><? } ?>
            </div>
            ...
            ?>
                ...
                <div class="col-6">
                    <h2> <input type="number" name="numero" id="numero" value="<?= $numero ?>" class="form-control" placeholder="Número Pedido para DEPOSITO" onkeyup="detectarEnterb(event)"></h2>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9" style="padding-top: 10px;">
                ...
                <!-- 
                    <input type="text" name="producto" id="producto" class="form-control" placeholder="Buscar Producto..." value="<? //= $producto 
                                                                                                                                    ?>" onkeyup="ajax_buscar($('#producto').val(),$('#numero').val(), $('#unidad').val());">
            ...
            <div class="col-lg-1" style="padding-top: 10px;">
                <input type="number" name="cantidad" id="cantidad" class="form-control" placeholder="Cant." min="0" onkeyup="detectarEnter(event);" style="<?= $verinpur ?>" onclick="select()">
            </div>
            ...
            <div class="col-lg-1" style="padding-top: 10px;">
                <button type="button" id="suminstr" class="btn btn-success" onclick="ajax_ordenbajar($('#producto').val(), $('#unidad').val(), $('#cantidad').val(),$('#numero').val());" style="width: 100%; <?= $verinpur ?>">Agregar</button>
                <script>
                    function detectarEnter(event) {
                        if (event.keyCode === 13) {
                            ajax_ordenbajar($('#producto').val(), $('#unidad').val(), $('#cantidad').val(), $('#numero').val());
                        }
                    }
                </script>
            </div>
    ...
    <? if ($id_orden != "dsds" && $veritem == "1") { ?>
        <div class="container mt-3">
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    ...
                    $sqlorden = mysqli_query($rjdhfbpqj, "SELECT * FROM itembajar Where id_orden = '$id_orden' ORDER BY `id` ASC");
        ...
        <div class="container mt-3 text-center">
            <!--  <a href="printorden.php"> <button type="button" class="btn btn-dark">Imprimir  Orden</button></a> <br><br>  --> <a href="guardarorden.php"><button type="button" class="btn btn-dark">Enviar a Deposito Planta Alta</button></a>
        </div>
        <br><?php
...
<?php } else { ?>
    ...
    <div class="col-7">
        ...
        <ul class="list-group" style="width: 100%;">
            ...
            ?>
                <li class="list-group-item"><a href="/statusorden/"><button type="button" class="btn btn-dark"><strong>CONTROL PICKING</strong></button></a>
                <li class="list-group-item"><a href="/control/"><button type="button" class="btn btn-dark"><strong>CONTROL</strong></button></a>
                    &nbsp;&nbsp;<a href="/deposito/verstock"><button type="button" class="btn btn-dark"><strong>STOCK</strong></button></a></li>
            ...
            ?>
                <li class="list-group-item"><a href="../deposito/"><button type="button" class="btn btn-dark"><strong>Ubicacion Productos</strong></button></a></li>
            <?php
                }
...
<? }
    ...
    <a href="../envasadopb/"><button type="button" class="btn btn-primary">Volver al Panel</button></a> 
...
<? if ($pan == "1" || $producto != '' || $_SESSION['tipo'] == "21") {
} else { ?>
    <a href="../lusuarios/logincerrar.php"><button type="button" class="btn btn-secondary btn-xs">Cerrar usuario</button></a><br><br>
<? } ?>
<script>
    function ajax_ordenbajar(producto, unidad, cantidad, numero, prioridad) {
        var sinstok = <?= $sinno ?>;

        if (numero && sinstok == '0') { // Verifica si numero tiene datos
            var parametros = {
                "producto": producto,
                "unidad": unidad,
                "cantidad": cantidad,
            ...
            alert("NO HAY STOCK!! O NO SE INGRESO EL NUMERO DE ORDEN!");
            document.getElementById('numero').focus();
        }
    }
</script>
