...
if ($confirmado == '1') {
    ...
    $sqlordend = "Update stockhgz1 Set id_producto='9.$iditem', connohay='$fechahoy',horacon='$horasin', iduscon='$id_usuarioclav' Where id_producto = '$iditem'";
    mysqli_query($rjdhfbpqj, $sqlordend) or die(mysqli_error($rjdhfbpqj));
    $origen = "Confirmo no hay Stock";
