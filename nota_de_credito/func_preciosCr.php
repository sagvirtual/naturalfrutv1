...
$sqldord = mysqli_query($rjdhfbpqj, "SELECT * FROM item_orden Where id_orden='$ordedecompra' and id_producto='$idprodu'");
...
if( $presentacio > 0){
 ...
 if($tipounidad == '0'){$preciounid=$rowudord['precio'];}else{
 ...
 if($unidad == 0){$preciouni=$preciounid;}else{
