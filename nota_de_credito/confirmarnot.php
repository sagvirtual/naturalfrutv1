...
if ( !empty( $idorden &&  $col == 2 ) ) {
        ...
        $sqlcliefes = "Update nota_credito Set col='2', fecha2='$fechahoy', hora2='$horasin' Where id = '$idorden'";
        mysqli_query( $rjdhfbpqj, $sqlcliefes ) or die( mysqli_error( $rjdhfbpqj ) );
    

        $sqlordenfm1 = mysqli_query( $rjdhfbpqj, "SELECT * FROM nota_credito Where id ='$idorden' and col>'1' and col<'8' and id_hoja='0'" );
