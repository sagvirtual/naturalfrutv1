<?php 
function ActualizaStockA($rjdhfbpqj, $idproduc, $cantidad, $id_orden) {
    ...
    function descontarStockA(&$stock, $cantidad, $rjdhfbpqj, $idproduc, $id_orden) {
...
if (mysqli_num_rows($result) > 0) {
    ...
    // Descontar el stock
    $restante = descontarStockA($stock, $cantidad, $rjdhfbpqj, $idproduc, $id_orden);
