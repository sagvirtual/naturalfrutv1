 ...
 if($mpc !='0'){$colspan="4";$altofoto='120';  $altofont='18';$altofontcaja='22'; $altotdfot='height:114px;'; $altoctdfot='height:114px;';}
                    ...
                    <tr>
                        <td>
                            ...
                            while ($rowecartes = mysqli_fetch_array($sqlcartes)){
                              ...
                              echo '
                              <img src="../cartelitos/'.$rowecartes['id_cartel'].'" style="height: '.$altocart.'px;  border: 0px; ">';
