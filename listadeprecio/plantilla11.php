 ...
 if($mpd !='0'){$colspan="5";$altofoto='190';}
 if($mpe !='0'){$colspan="6"; $altofoto='230';}  
echo'
                        ...
                        <td>
                            <table cellPadding="0" cellSpacing="0" style=" width: 100%;  border: 0.5mm solid black;  border-top:  0.1mm solid black;  font-size: 12pt;">
                                ...
                                <tr>
                                 ...
                                 }else{$colorcartes="#948A54";$textcar="&nbsp;";}
 
 

                                        echo'
                                    <td style="text-align:right; background-color: '.$colorcartes.'; color:white; border-left: 0.1mm solid black; border-bottom: none; font-size: 16pt; padding-right: 10px; border-bottom: none; padding-top: 1px;">'.$textcar.'</td>';
                                ...
                                if($mpd !='0'&& $mkd !='0'){
                                    ...
                                    if($mpe !='0'&& $mke !='0'){
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right; background-color: black; color:'.$colorfonpretext.'; border-left: 0.1mm solid black; border-bottom: none; font-size: 26pt; padding-right: 10px; border-bottom: none; padding-top: 1px;"> $ '.$mpeb.'</td>
                                        </tr>';}
