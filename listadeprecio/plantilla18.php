                    ...
                    <tr>
                        <td>
                            ...
                            while ($rowecartes = mysqli_fetch_array($sqlcartes)){
                              ...
                              echo '
                              <img src="../cartelitos/'.$rowecartes['id_cartel'].'" style="height: 100px;  border: 0px; ">';
                            ...
                            echo'</tr>
                                ...
                                <tr>
                                        ...
                                        <table style=" width:100%;">
                                            <tr>
                                                ...
                                                <td style="text-align: right;font-size: 14pt;">
                                                  ...
                                                  <font style="color:#83148E;">Precios: Por</font>
                                                ...
                                                <td style=" width:140px; height:30px; text-align:center; background-color: '.$colorfonpre.'; color:'.$colorfonpretext.';  border-left: 0.1mm none black; border-bottom: none; font-size: 16pt;padding-right: 10px ;padding-left: 10px; ">&nbsp;
                                   ...
                                   echo' </td>
                                    <td style="width:108px; text-align:center;background-color: '.$colorfonpre.'; color:'.$colorfonpretext.';  border-left: none; border-bottom: none; font-size: 16pt;padding-right: 10px;padding-left: 10px; ">$ '.$mpc.'</td>
                                </tr>';
                            ...
                            if($mpd !='0'&& $mkd !='0'){
                                echo' <tr>
                                     ...
                                     <td colspan="2" style="text-align:center; background-color:white; color:'.$colorfonpretextb.'; border-left:none; border-bottom: none; font-size: 30pt;  border-bottom: none; padding-top: 1px;">&nbsp;$ '.$mpd.'&nbsp;</td>
                                 </tr>';
                             }
                             ...
                             if($mpe !='0'&& $mke !='0'){
                                echo' <tr>
                                     ...
                                     <td colspan="2" style="text-align:center; background-color:'.$colorfonpre.'; color:'.$colorfonpretext.'; border-left:none; border-bottom: none; font-size: 30pt;  border-bottom: none; padding-top: 1px;">&nbsp;$ '.$mpe.'&nbsp;</td>
                                 </tr>';
                             }
