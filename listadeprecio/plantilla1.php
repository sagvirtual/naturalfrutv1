   ...
   $haycar=${"haycar".$idpro};
   $sqlcardtes=${"sqlcardtes".$idpro};
   $roweccartes=${"roweccartes".$idpro};
   $tdpr=${"tdpr".$idpro};
$sqlcardtes=mysqli_query($rjdhfbpqj,"SELECT * FROM editliscartel Where fecha = '$fechalistaca' and tipolista = '0'  and id_producto='$idpro'");

if ($roweccartes = mysqli_fetch_array($sqlcardtes)){
...
echo'
                <table cellPadding="0" cellSpacing="0" style=" '.$anchotable.'  border: none; ">
                    <tr>
                        <td>
                            <table cellPadding="0" cellSpacing="0" style="  border: 0.5mm solid black;  border-top:  0.1mm solid black;  font-size: 12pt;">
                                <tr>
                                    <td colspan="2" style="width: 550px; height: 50px; background-color:'.$str.'; text-align:right; border: none; font-size: 18pt; padding: 3px; padding-right: 10px;">
                                    ';
                                    echo '<p>';
                                    if($palabras !=""){
                                   ...
                                   echo' <td colspan="3" style="width: 214px; height: 50px;background-color: '.$colorcartes.'; text-align:center; border: none; font-size: 16pt;   color:white;">'.$textcar.'</td>';
                          ...
                          ';}else{$tdpr='colspan="2"';}
                                ...
                                echo'<tr>
                                    <td '.$tdpr.' style="text-align:right; background-color:'.$str.'; border: none; font-size: 20pt; padding-right: 10px; border-bottom: none; border-top: none; padding-top: 1px ">
